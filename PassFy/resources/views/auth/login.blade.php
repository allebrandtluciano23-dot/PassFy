        ...
        <form class="form-login" id="form-login" method="POST" action="{{ route('login.cliente') }}">
            ...
            <div class="check-remember">
                <div class="checkbox-wrapper-14">
                    <input id="s1-14" type="checkbox" class="switch" name="remember">
            ...
            <button id="google-login-btn" type="button"><i class="fa-brands fa-google"></i> Faça login com o Google</button>
